...
SECRET_KEY = 'django-insecure-4c^r+q)bki2_%*6$u)gd0&hsoncglmh^-x9ph1we@%!9etkqr0'
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://red-cjhin4b6fquc73cbdpe0:6379',  # Update the host here
        'OPTIONS': {
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": ['redis://red-cjhin4b6fquc73cbdpe0:6379'],
        },
    },
}
